                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @if(empty($item->com_logo))
                                                    <img class="img-thumbnail" id="image" src="{{asset('public/company/default.png')}}" width="150px" height="150px">
                                                @else
                                                    <img class="img-thumbnail" id="image" src="{{asset('public/company/'.$item->com_logo)}}" width="150px" height="150px">
                                                @endif
                                    ...
                                    <div class="col-md-6 col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="address"  value="{{$item->address}}" placeholder="Company Address">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-12">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" class="form-control" name="f_address" value="{{$item->copyright_text}}"  >
                                        </div>
                                    </div>
